...
// ------- стоит ли говорить о процессе  компиляции? (можно если спросят) --------
...
// -> Parser (иденцифицирует части | определяет функция это или переменная или...)
