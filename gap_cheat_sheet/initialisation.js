...
// поскольку только что определенная пе ременная приобретает
...
// c28. Кайл Симпсон 
// ...имейте в виду, что «инициализация» возможна и без явного присвоения значения,
// в частности достаточно выражения let b;
// Переменная, которой во время объявления ничего не присваивается,
// по умолчанию получает значение undefined
// с.31 
// имейте в виду, что «инициализация» возможна и без явного присвоения значения,
// в частности достаточно выражения let b; Переменная, которой во время объявления
// ничего не присваивается, по умолчанию получает значение undefined
